      ...
      <div class="server">
        <table width="100%">
          ...
          <tr>
            ...
            <td><div id="J_install_tip_dbprefix"><span class="gray">建议使用默认，同一数据库安装多个weishop时需修改</span></div></td>
          </tr>
        </table>
		<table width="100%">
          <tr>
          ...
          <tr>
            ...
            <td><input type="text" name="sitename" value="内容管理框架" class="input"></td>
          ...
          <tr>
            <td class="tar">描述：</td>
            <td><input type="text" name="siteinfo" class="input" value="一款基于PHP+MySql开发的客户管理+Eb电商系统，其中免费版是完全开源的版本，采用MVC设计模式实现业务逻辑与表现层的适当分离，使网页设计师能够轻松设计出理想的模板，可面向中小型站点提供重量级微信公众号商城建设和微信小程序建设。对于那些想要进行开发，但技术不足的站长们是一个难得的系统。微信商城微信小程序建站，就的开发旨在帮助创业者搭建企业电商平台，实现创业梦想。"></td>
