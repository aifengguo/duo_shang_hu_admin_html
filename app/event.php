...
return [
    ...
    'listen'    => [
        ...
        'StoreProductUserOperationConfirmAfter' => [], // ProductSubscribe 用户操作商品添加事件  用户点赞商品  用户收藏商品 Models模块 store.StoreProductRelation Model
        'StoreProductUserOperationCancelAfter' => [], // ProductSubscribe 用户操作商品取消事件  用户取消点赞商品  用户取消收藏商品 Models模块 store.StoreProductRelation Model
